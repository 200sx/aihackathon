...
ID = {
    ...
    "19148": "137,19148,72,1,2,1,0,1,31,0,20000,4,1,250,21,10,0.6",
...
def searchfun():
	...
	if request.method == 'POST':
		...
		return render_template("person.html", api=result, details=Personal[name], res=pred_res, pred_bool=pred_int)
